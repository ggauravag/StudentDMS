...
<html>
 ...
 <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
      <fieldset>
       <legend> <h3>Rank List</h3></legend>
        </fieldset>
        <form class="form-horizontal" role="form" action="" method="post">
		  <div class="form-group">
		  <h2>Performance Assessment Test ( Normal )</h2>
		  ...
		  <tr>
		    ...
		    <%
			    	...
			    	String query = "select st.st_name,st.branch,r.marks from student st, result r where st.st_id = r.st_id and r.exam_name = 'PAE-Normal:1' order by marks desc";
		  ...
		  <div class="form-group">
		  <h2>Performance Assessment Test ( Hacker's Edition )</h2>
		  <table class="table table-striped">
		  <tr>
		    ...
		    <%
		    		ps.close();
		    		res.close();
			    	query = "select st.st_name,st.branch,r.marks from student st, result r where st.st_id = r.st_id and r.exam_name = 'Hacker:1' order by marks desc";
