       ...
       <legend> <h1>Class Details</h1></legend>
        ...
        <form class="form-horizontal" role="form" action="" method="post">
		  ...
		  <%
		  	...
		  	String q = "select st_id,st_name,mobile,`date`,`status`,ip from student st, attendance att where att.id = st.st_id and att.date =  ? order by st_name";
		  ...
		  <form action="servlet/Download?date=<%=date %>" method="post" target="_blank">
		  <input type="submit" name="print" value="Download" class="col-sm-offset-5 btn-lg btn-success">
		  </form>
		  </div>
