...
<html>
 ...
 <body>
    ...
    <div class="container">
      ...
      <fieldset>
       <legend> <h1>Class Attendance</h1></legend>
        </fieldset>
        <form class="form-horizontal" role="form" action="" method="post">
		  ...
		  <%
		  	try
		  	{
		  	String q = "select count(st_id) from student";
		  	PreparedStatement pre = con.prepareStatement(q);
		  	ResultSet result = pre.executeQuery();
		  	result.next();
		  	int count = result.getInt(1);
		  	
		  	String query = "select * from class order by date";
			...
			%>
			<tr>
				<td><a href="admin/ViewDetailClass.jsp?date=<%=rs.getDate(2)%>" target="_blank">View</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin/MarkAttend.jsp?date=<%=rs.getDate(2)%>" target="_blank">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    <a href="admin/ViewCopy.jsp?date=<%=rs.getDate(2)%>" target="_blank">Suspect</a></td>
				<td><%=rs.getInt(1) %></td>
				<td><%=rs.getDate(2) %></td>
				<td><%=rs.getInt(3) %></td>
				<td><%=count %></td>
