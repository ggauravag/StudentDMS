...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	...
	session.setAttribute("ex", "Hacker");
	session.setAttribute("ename", "Hacker:1");
	String query = "insert into result values(?,?,now(),?,?,?,?)";
	PreparedStatement ps = con.prepareStatement(query);
	ps.setInt(1, id);
	ps.setString(2, "Hacker:1");
	ps.setString(3, "eeeeeeeeee");
	ps.setString(4,"eeeeeeeeee");
	ps.setInt(5, 0);
	ps.setString(6, "FAIL");
	
	int j = ps.executeUpdate();
	ps.close();
	ps = con.prepareStatement("select * from hackertest where qno = ?");
	ps.setInt(1, qno);
...
<html>
  <head>
    ...
    <title>Advanced Performance Assessment Test</title>
    ...
    function loadNewQues(x)
    {
			    	...
			    	if(qno == "6")
			    	{
			    		ques = "Which header file(s) contain getch() & clrscr() function's declaration ?";
			    		op1 = "conio.h";
			    		op2 = "stdio.h";
			    		op3 = "conio.h & stdio.h";
			    		op4 = "math.h";
			    	...
			    	if(qno == "11")
			    	{
			    		ques = "In mathematics and computer programming, which is the correct order of mathematical operators ?";
			    		op1 = "Addition, Subtraction, Multiplication, Division";
			    		op2 = "Division, Multiplication, Addition, Subtraction";
			    		op3 = "Multiplication, Addition, Subtraction, Division ";
			    		op4 = "Addition, Division, Modulus, Subtraction";
			    		img = "";
			    	}
			    	
			    	if(qno == "14")
			    	{
			    		ques = "What is the ASCII code of 'A' & 'a' ?";
			    		op1 = "65 & 97";
			    		op2 = "66 & 98";
			    		op3 = "98 & 68";
			    		op4 = "97 & 65";
